...
function idcheck(){
	...
	window.open(url,"_blank_1","toolbar=no,menubar=no,scrollvars=yes,resizble=no,width=330,height=200");
...
function post_zip(){
	...
	window.open(url,"_blank_1","toolbar=no, menubar=no,scrollbars=yes,resizble=no,width=550,height=300,top=300,left=300");
}
